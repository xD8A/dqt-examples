...
private:
    @QSlot void updateValidator()
    {
        ...
        import qt.gui.validator : QIntValidator, QValidator;
    ...
    {
        import core.stdcpp.new_ : cpp_delete, cpp_new;
        import qt.gui.validator : QDoubleValidator, QValidator;

        auto v = cpp_new!QDoubleValidator(ui.doubleMinVal.value(), ui.doubleMaxVal.value(), ui.doubleDecimals.value(), this);
